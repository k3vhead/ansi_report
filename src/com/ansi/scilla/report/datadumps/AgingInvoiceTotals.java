...
public class AgingInvoiceTotals extends DataDumpReport implements ReportByNoInput {
	...
	public static final  String REPORT_TITLE = "Aging Invoice Totals";
	...
	protected static final String sql = "select year, month, \n" + 
			...
			"from \n" + 
			"(select act_price_per_cleaning, concat(division_nbr,'-',division_code) as Div, datepart(yy, invoice_date) as year, datepart(MM, invoice_date) as month\n" + 
			"from ticket\n" + 
	...
	public static AgingInvoiceTotals buildReport(Connection conn) throws Exception {
		return new AgingInvoiceTotals(conn);
	}
