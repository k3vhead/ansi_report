...
public class AgingPaymentTotals extends DataDumpReport implements ReportByNoInput {
	
	private static final long serialVersionUID = 1L;
	public static final String FILENAME = "Aging Payment Totals";
	
	public AgingPaymentTotals(Connection conn) throws Exception{
		super();
		super.sql = sql;
	...
	public static final  String REPORT_TITLE = "Aging Payment Totals (no service taxes)";
	...
	protected static final String sql = "select year, month,\n" + 
			...
			"from \n" + 
			"(select ticket_payment.amount, concat(division_nbr,'-',division_code) as Div, datepart(yy, payment_date) as year, datepart(MM, payment_date) as month\n" + 
			"from ticket_payment\n" + 
	...
	public static AgingPaymentTotals buildReport(Connection conn) throws Exception {
		return new AgingPaymentTotals(conn);
	}
