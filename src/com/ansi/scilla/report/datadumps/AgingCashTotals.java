...
public class AgingCashTotals extends DataDumpReport implements ReportByNoInput {
	...
	public static final String FILENAME = "Aging Cash Totals";
	
	public AgingCashTotals(Connection conn) throws Exception{
		super();
		super.sql = sql;
	...
	public static final  String REPORT_TITLE = "Aging Cash Totals";
	...
	protected static final String sql = "select year, month,\n" + 
			...
			"from \n" + 
			"(select ticket_payment.amount+ticket_payment.tax_amt as total_amt, concat(division_nbr,'-',division_code) as Div, datepart(yy, payment_date) as year, datepart(MM, payment_date) as month\n" + 
			"from ticket_payment\n" + 
	...
	public static AgingCashTotals buildReport(Connection conn) throws Exception {
		return new AgingCashTotals(conn);
	}
