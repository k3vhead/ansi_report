...
public class PastDueReport extends StandardReport {
	...
	private void makeData(Connection conn, Calendar pastDueDate, Integer divisionId) throws Exception {
		...
		super.setHeaderRow(new ColumnHeader[] {
			...
			new ColumnHeader("jobId","JOB #", 1, 0, DataFormats.STRING_FORMAT, SummaryType.NONE),//JOB#
			new ColumnHeader("invoiceDate", "Contracts", 1, 0, DataFormats.DATE_FORMAT, SummaryType.NONE),//completed invoiced dates
			new ColumnHeader("jobId", "JOB", 1, 0, DataFormats.STRING_CENTERED, SummaryType.NONE),//job number
			new ColumnHeader("actPPC", "PPC", 1, 0, DataFormats.NUMBER_CENTERED, SummaryType.NONE),//actPPC
			new ColumnHeader("amountPaid", "PAID AMOUNT", 1, 0, DataFormats.NUMBER_FORMAT, SummaryType.NONE),//Paid Amount
			new ColumnHeader("amountDue", "AMOUNT DUE", 1, 0, DataFormats.NUMBER_FORMAT, SummaryType.NONE),//amountDue
