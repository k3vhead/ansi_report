...
public class CreditCardFeesDataReport extends StandardReport implements ReportByStartEnd {
	...
	private final String sql = "select concat(division_nbr,'-',division_code) as div,\n" + 
			...
			"and payment_date >= '2020-04-01' and payment_date < '2020-07-01' \n" + 
			"order by div, payment_date";
	
	/*div, payment, amount, type, payment_status, payment_date, payment_note,
	check_nbr, check_date, payment_method,
	added_by, added_date, updated_by, updated_date, ticket_id, payment_id, amount, tax_amt,
	ticket_payment_status, added_by...
	year, month, total, fee, day*/
	

	
	public static final String REPORT_TITLE = "Credit Card Fees Data Report";
	public static final String FILENAME = "CreditCardFeesDataReport";
//	private final String REPORT_NOTES = "notes go here";
	...
	public CreditCardFeesDataReport() {
		super();
	 ...
	 */
	protected CreditCardFeesDataReport(Connection conn) throws Exception {
		this();
	...
	protected CreditCardFeesDataReport(Connection conn, Calendar startDate, Calendar endDate) throws Exception {
		this();
		DateFormatter dateFormatter = (DateFormatter)DataFormats.DATE_FORMAT.formatter();
	...
	private List<RowData> makeData(Connection conn, CreditCardFeesDataReport report, Calendar startDate, Calendar endDate) throws Exception {
...
//		});
	...
	public static CreditCardFeesDataReport buildReport(Connection conn) throws Exception {
		return new CreditCardFeesDataReport(conn);
	}
	public static CreditCardFeesDataReport buildReport(Connection conn, Calendar startDate, Calendar endDate) throws Exception {
		return new CreditCardFeesDataReport(conn, startDate, endDate);
	}
