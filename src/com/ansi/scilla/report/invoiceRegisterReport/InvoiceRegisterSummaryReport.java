...
public class InvoiceRegisterSummaryReport extends StandardSummaryReport implements ReportByStartEnd {

	private static final long serialVersionUID = 1L;
	
	public static final String FILENAME = "IRR_Summary";
	

	public static final String REPORT_TITLE = "Invoice Register Summary";
//	private final String REPORT_NOTES = null;
	...
	public InvoiceRegisterSummaryReport() {
	 ...
	 */
	protected InvoiceRegisterSummaryReport(Connection conn) throws Exception {
		super(
			(StandardReport)(new InvoiceRegisterDivisionSummary(conn)),
			(StandardReport)(new InvoiceRegisterRegionSummary(conn)),
			(StandardReport)(new InvoiceRegisterCompanySummary(conn))
			);
	...
	protected InvoiceRegisterSummaryReport(Connection conn, Calendar startDate, Calendar endDate) throws Exception {
		super(
			(StandardReport)(new InvoiceRegisterDivisionSummary(conn, startDate, endDate)),
			(StandardReport)(new InvoiceRegisterRegionSummary(conn, startDate, endDate)),
			(StandardReport)(new InvoiceRegisterCompanySummary(conn, startDate, endDate))
			);
	...
	public static InvoiceRegisterSummaryReport buildReport(Connection conn) throws Exception {
		return new InvoiceRegisterSummaryReport(conn);
	}
	
	public static InvoiceRegisterSummaryReport buildReport(Connection conn, Calendar startDate, Calendar endDate) throws Exception {
		return new InvoiceRegisterSummaryReport(conn, startDate, endDate);
	}
