package com.ansi.scilla.report.invoiceReceiptsRegister;
...
public class InvoiceRegisterDivisionSummary extends StandardReport implements ReportByStartEnd {
	...
	private List<RowData> makeData(Connection conn, InvoiceRegisterDivisionSummary report, Calendar startDate, Calendar endDate) throws SQLException {
