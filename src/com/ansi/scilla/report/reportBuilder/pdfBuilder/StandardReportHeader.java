...
/**
 * Page header for standard reports. Freely stolen from https://memorynotfound.com/adding-header-footer-pdf-using-itext-java
 * @author dclewis
 *
 */
public class StandardReportHeader extends PdfPageEventHelper {
	...
	private void makeHeaderTable(StandardReport report) throws Exception {
