...
public class LiftAndGenieDivisionSummary extends StandardReport {
	...
	private void makeReport(Calendar startDate, Calendar endDate, List<RowData> data, String subtitle) throws NoSuchMethodException, SecurityException {
		...
		super.setHeaderRow(new ColumnHeader[] {
				new ColumnHeader("name", "Div", 1, DataFormats.STRING_FORMAT, SummaryType.NONE),
				new ColumnHeader("amount", "Lift_DL", 1, DataFormats.DECIMAL_FORMAT, SummaryType.SUM),
