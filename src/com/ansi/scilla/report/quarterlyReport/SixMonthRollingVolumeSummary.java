...
//}
	...
	private void makeData(Connection conn) throws Exception {
		...
		super.setHeaderRow(new ColumnHeader[] {
			new ColumnHeader("quarterEnd", "Quarter End", 2, 0, DataFormats.DATE_FORMAT, SummaryType.NONE),
			new ColumnHeader("jobCount","Job Count", 1, 0, DataFormats.NUMBER_FORMAT, SummaryType.NONE),
			new ColumnHeader("contracts", "Contracts", 1, 0, DataFormats.NUMBER_FORMAT, SummaryType.NONE),
			new ColumnHeader("volForecastOct", "Oct", 1, 0, DataFormats.NUMBER_CENTERED, SummaryType.NONE),
			new ColumnHeader("volForecastNov", "Nov", 1, 0, DataFormats.NUMBER_CENTERED, SummaryType.NONE),
			new ColumnHeader("volForecastDec", "Dec", 1, 0, DataFormats.NUMBER_FORMAT, SummaryType.NONE),
			new ColumnHeader("quarter1", "Quarter", 1, 0, DataFormats.NUMBER_FORMAT, SummaryType.NONE),
			new ColumnHeader("volForecastJan", "Jan", 1, 0, DataFormats.NUMBER_FORMAT, SummaryType.NONE),
			new ColumnHeader("volForecastFeb", "Feb", 1, 0, DataFormats.NUMBER_FORMAT, SummaryType.NONE),
			new ColumnHeader("volForecastMar", "Mar", 1, 0, DataFormats.NUMBER_FORMAT, SummaryType.NONE),
			new ColumnHeader("quarter2", "Quarter", 1, 0, DataFormats.NUMBER_FORMAT, SummaryType.NONE),
			new ColumnHeader("volForecastApr", "Apr", 1, 0, DataFormats.NUMBER_FORMAT, SummaryType.NONE),
			new ColumnHeader("volForecastMay", "May", 1, 0, DataFormats.NUMBER_FORMAT, SummaryType.NONE),
			new ColumnHeader("volForecastJun", "Jun", 1, 0, DataFormats.NUMBER_FORMAT, SummaryType.NONE),
			new ColumnHeader("quarter3", "Quarter", 1, 0, DataFormats.NUMBER_FORMAT, SummaryType.NONE),
			new ColumnHeader("volForecastJul", "Jul", 1, 0, DataFormats.NUMBER_FORMAT, SummaryType.NONE),
			new ColumnHeader("volForecastAug", "Aug", 1, 0, DataFormats.NUMBER_FORMAT, SummaryType.NONE),
			new ColumnHeader("volForecastSep", "Sep", 1, 0, DataFormats.NUMBER_FORMAT, SummaryType.NONE),
			new ColumnHeader("quarter4", "Quarter", 1, 0, DataFormats.NUMBER_FORMAT, SummaryType.NONE),
			new ColumnHeader("annual", "Annual", 1, 0, DataFormats.NUMBER_FORMAT, SummaryType.NONE),
			new ColumnHeader("jobAvg", "Ave $/Job", 1, 0, DataFormats.NUMBER_FORMAT, SummaryType.NONE),
			new ColumnHeader("contractAvg", "Ave $/Cont", 2, 0, DataFormats.NUMBER_FORMAT, SummaryType.NONE)
		});		
